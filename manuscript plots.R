...
ggplot(full.outputs.combo, aes(as.factor(preference), as.factor(attention), fill = med.forXpre.str)) +
...
ggsave("./ms_plots/Figure1A_Median change in producer's strength between phases 1 and 2.pdf", 
       width = 15,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
        ...
        labs(title=paste0("Effect of Attention on Median Change \nin Producer's Strength (scaled by groupsize) \nbetween phases 1 and 2 \n- Scrounging Enabled"), 
             x = "Attention", 
             y = "Change in producer's strength",
             color = "Group size")+
        theme_classic() +
        scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure1B_Effect of Attention on Median Change in Producer's Strength.pdf", 
       width = 7,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  theme_classic() +
  scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure1C_Effect of Preference on Median Change in Producer's Strength.pdf", 
       width = 7,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  theme_classic() +
  scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure1D_Effect of Memory on Median Change in Producer's Strength.pdf", 
       width = 15,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  ggplot(aes(x=mem, y=median, group=groupsize)) + 
    ...
    theme_classic() +
    scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure1E_Effect of Memory on Median Proportion Phase2.pdf", 
       width = 15,
       height = 7,
       dpi = 300)
...
ggplot(full.outputs.combo, aes(as.factor(preference), as.factor(attention), fill = med.postXfor.str)) +
  ...
  theme_minimal() +
  theme(aspect.ratio=1, text=element_text(size=15))
ggsave("./ms_plots/Figure2A_Median change in producer's strength between phases 2 and 3.pdf", 
       width = 15,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  theme_classic() +
  scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure2B_Effect of Attention on Median Change in Producer's Strength.pdf", 
       width = 7,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  theme_classic() +
  scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure2C_Effect of Preference on Median Change in Producer's Strength.pdf", 
       width = 7,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  theme_classic() +
  scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure2D_Effect of Memory on Median Change in Producer's Strength.pdf", 
       width = 15,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  theme_classic() +
  scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure2E_Effect of Memory on Median Proportion Phase3.pdf", 
       width = 15,
       height = 7,
       dpi = 300)
...
ggplot(full.outputs.combo, aes(as.factor(preference), as.factor(attention), fill = med.combo.energy)) +
  ...
  theme_minimal() +
  theme(aspect.ratio=1, text=element_text(size=15))
ggsave("./ms_plots/Figure3A_Median Scrounger Energy.pdf", 
       width = 15,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  theme_classic() +
  scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure3B_Effect of Attention on Median Scrounger Energy.pdf", 
       width = 7,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  theme_classic() +
  scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure3C_Effect of Preference on Median Scrounger Energy.pdf", 
       width = 7,
       height = 7,
       dpi = 300)
...
full.outputs %>% 
  ...
  theme_classic() +
  scale_color_manual(values = c("3" = "gold2", "6" = "darkorange", "10" = "red1", "15" = "red4"))
ggsave("./ms_plots/Figure3D_Effect of Memory on Median Scrounger Energy.pdf", 
       width = 7,
       height = 7,
       dpi = 300)
