...
#gam visualization shows maybe quatric function for attention and pref, cubic for mem
mod.23.2 = lm(scld.postXfor.str ~ attention + preference + mem + I(attention^2) + I(preference^2) + I(mem^2) + I(attention^3) + I(preference^3) + I(attention^4)*I(preference^4)*I(mem^3),
            data = subset.outputs)
...
##Plotting effects from GAMs from previous chunk
```{r}
