...
AIC(mod.12.4, mod.12.5) #lower = better fit
...
#QUESTION 1 RESULTS: 
summary(mod.12.4)
#rather than sqrt transforming y variable, report robust standard errors which correct for heteroscedasticity
library(sandwich)
library(lmtest)
...
#gam visualization (see next R chunk) shows maybe quatric function for attention and pref, cubic for mem
...
##Plotting effects of each predictor from GAMs from previous chunk
```{r}
...
#####
#plot GAM effects with raw data for scrounger energy
preds.12.att2 = ggeffects::ggpredict(mod.12.gam2, terms = c("attention", "preference", "mem")) %>%
...
preds.12.pref2 = ggeffects::ggpredict(mod.12.gam2, terms = c("preference", "attention", "mem")) %>%
...
preds.12.mem2 = ggeffects::ggpredict(mod.12.gam2, terms = c("mem", "preference", "attention")) %>%
                    rename(Preference = "group",
                           attention = "facet")
...
#####
#plot GAM effects with raw data for scrounger energy
preds.23.att2 = ggeffects::ggpredict(mod.23.gam, terms = c("attention", "preference", "mem")) %>%
                    rename(Preference = "group",
                           mem = "facet")
...
preds.23.pref2 = ggeffects::ggpredict(mod.23.gam, terms = c("preference", "attention", "mem")) %>%
                    rename(Attention = "group",
                           mem = "facet")
...
preds.23.mem2 = ggeffects::ggpredict(mod.23.gam, terms = c("mem", "preference", "attention")) %>%
                    rename(Preference = "group",
                           attention = "facet")
...
preds.energy.att2 = ggeffects::ggpredict(mod.energy.gam, terms = c("attention", "preference", "mem")) %>%
                    rename(Preference = "group",
                           mem = "facet") #rename the facet column to match the name in subset.outputs so that the plot is faceted correctly
...
preds.energy.pref2 = ggeffects::ggpredict(mod.energy.gam, terms = c("preference", "attention", "mem")) %>%
                    rename(Attention = "group",
                           mem = "facet") #rename the facet column to match the name in subset.outputs so that the plot is faceted correctly
...
preds.energy.mem2 = ggeffects::ggpredict(mod.energy.gam, terms = c("mem", "preference", "attention")) %>%
                    rename(Preference = "group",
