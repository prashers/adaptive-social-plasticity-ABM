...
#query for checking number of resets/food depletions across group sizes
```{r}
...
#Chunk for getting metrics of foraging success for agents other than the producer
```{r}
...
#Check how approachfood, resetfoodconsistent, and resizearena impact average energy levels achieved by foragers at the end of each model run
```{r}
...
#    str.range1 = str.range[25:30]
  ...
  dir.create(paste(file.path, "plots", sep = "/")) #create in a new folder in the current working directory that will hold all the plots from this loop
