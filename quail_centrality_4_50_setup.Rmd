...
query = "SELECT run,  
                ...
                currentsuccforagers, 
                energylist 
        FROM quail_centrality_4_50 order by run, ticks"; #UPDATE IF YOU WANT TO SELECT ONLY CERTAIN MEMORY VALUES
rs = dbSendQuery(conn, query)
...
num.combos = 9000 #UPDATE AFTER YOU KNOW HOW WHICH COMBOS YOU ARE INTERESTED IN
...
#data.ord[rownames(data.ord) == 15050, colnames(data.ord) %in% c("groupsize", "mem", "attention", "preference", "approachfood", "resetfoodconsistent", "resizearena")] #checking whether combo changes every 15050 rows
...
write_csv(data.ord, "C:/Users/sanja/Documents/Sanjay's stuff/QuailCentralityABM/R analyses/quail_centrality_4/data_ord_50.csv") #saving csv here so I can run the big loop after restarting R with clean memory
...
#THIS DID NOT RUN FOR GROUP SIZE 20 (5 runs per combo)
